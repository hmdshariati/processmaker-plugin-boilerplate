...
foreach ($G_TMP_MENU->Id as $index => $value) {
  if ($index == 3) { //Option CASES_INBOX
    $tmpId[$index + $k]      = "ID_DELETECASES_MNUCASE_01";
    $tmpTypes[$index + $k]   = "plugins";
    $tmpEnabled[$index + $k] = 1;
    $tmpOptions[$index + $k] = "../deleteCases/deleteCasesApplication"; //link
    $tmpLabels[$index + $k]  = "deleteCases application1";
    $tmpJS[$index + $k]      = null;
...
$tmpId[$i]      = "ID_DELETECASES_MNUCASE_02";
$tmpTypes[$i]   = "blockHeader";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = null; //link
$tmpLabels[$i]  = "deleteCases application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_DELETECASES_MNUCASE_03";
$tmpTypes[$i]   = "plugins";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../deleteCases/deleteCasesApplication2"; //link
$tmpLabels[$i]  = "deleteCases application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_DELETECASES_MNUCASE_04";
$tmpTypes[$i]   = "blockHeaderNoChild";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../deleteCases/deleteCasesApplication3"; //link
$tmpLabels[$i]  = "deleteCases application3";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
