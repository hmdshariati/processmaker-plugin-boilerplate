Ext.namespace("stepdeleteCases");

stepdeleteCases.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../deleteCases/stepdeleteCasesApplicationAjax",
        method: "POST",
...
Ext.onReady(stepdeleteCases.application.init, stepdeleteCases.application);