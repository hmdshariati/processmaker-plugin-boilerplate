...
try {
  ...
  $oHeadPublisher->addContent("deleteCases/stepdeleteCasesApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("deleteCases/stepdeleteCasesApplication", false); //Adding a javascript file .js
